...
public class Doctors extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
        ...
        while (docItr.hasNext()) 
        {
            ...
            out.println("</hr>");
            out.println("doc id:"+ doc.getDoc_id()+"doc name:"+doc.getDoc_name() + "Doc dob:"+doc.getDob()+ "speciality :"+doc.getSpeciality() +"city:"+ doc.getCity() + "phone no:"+ doc.getPhone_no()+"standard_fees:"  + doc.getStandard_fees()+"</p>");
        }
	}
